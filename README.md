...
model cache. An optional Chrome/noVNC/Playwright bundle provides a persistent,
isolated ChatGPT profile and project-scoped Codex MCP. Managed task worktrees
default to a locked container-native volume. Godot downloads are
architecture-specific and checksum-verified. Creation and modification require
explicit approval of every configurable choice before planning and approval of
the resolved plan before applying it.
